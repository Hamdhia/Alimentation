...
<body>
                ...
                @foreach ($produits as $produit)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('crud.edit', $produit->id) }}" class="btn btn-primary">Modifier</a>
                            <a href="{{ route('destroy.produit', $produit->id) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?')">Supprimer</a>
    ...
    <div class="container">
         <form action="" method="post" class="btn btn-success">
            @csrf
