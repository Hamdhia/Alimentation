...
<div class=" bloc1">
  <form action="{{ route('admin.store') }}" style="margin-top:20px" method="POST">
      @csrf
    ...
    <div class="form-floating">
      <input type="tel" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name" name="numero" placeholder="your number"  style="border-radius:20px">
      <label for="name">votre numero</label>
      @error('prenom')
      <div class="invalid-feedback">
      {{ $message }}
      </div>
