            ...
            <tbody>
                @foreach ($produits as $produit)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('detail/'.$produit->id) }}" class="btn btn-success">Afficher</a>
                            ...
                            <a href="{{ route('destroy.produit/'.$produit->id) }}" style="display: inline;">
                                ...
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?')">Supprimer</button></a>
